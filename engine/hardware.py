"""Dynamic hardware detection — CPU & GPU profiling for 70% utilization."""
...
def compute_allocation(hw=None, target_utilization=0.70):
    """Compute optimal CPU/GPU allocation for 70% utilization.
    ...
    # Use 70% of logical cores for rendering.
